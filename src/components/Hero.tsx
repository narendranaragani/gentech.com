...
const techStack = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-7 w-7">
        ...
        <path
          d="M21.7 17.55C18.66 19.8 14.24 21 10.43 21c-5.34 0-10.15-1.97-13.79-5.26-.29-.26-.03-.61.31-.41 3.93 2.28 8.78 3.66 13.8 3.66 3.39 0 7.11-.7 10.53-2.15.51-.22.94.34.42.71z"
          transform="translate(2)"
        />
        <path
          d="M22.97 16.11c-.39-.5-2.58-.24-3.57-.12-.3.04-.34-.22-.07-.41 1.74-1.22 4.6-.87 4.93-.46.34.41-.09 3.27-1.72 4.63-.25.21-.49.1-.38-.18.37-.92 1.2-2.97.81-3.46z"
          transform="translate(-2)"
        />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-7 w-7">
        <path
          d="M11.91 1.5c-1.27 0-2.48.11-3.55.31-3.13.55-3.7 1.71-3.7 3.85V8.5h7.4v.94H1.86c-2.16 0-4.04 1.3-4.63 3.76a13.4 13.4 0 0 0 0 6.27c.52 2.32 1.83 3.76 3.99 3.76h2.04v-3.41c0-2.45 2.12-4.62 4.65-4.62h7.39c2.06 0 3.7-1.7 3.7-3.77V5.66c0-2.01-1.7-3.52-3.7-3.85a23.21 23.21 0 0 0-3.39-.31zM7.91 3.77a1.39 1.39 0 1 1 .01 2.78 1.39 1.39 0 0 1-.01-2.78z"
          transform="translate(2.5 0)"
        />
        <path
          d="M21.14 9.44v3.32c0 2.55-2.16 4.7-4.65 4.7H9.1c-2.01 0-3.7 1.73-3.7 3.77v7.06c0 2.01 1.74 3.19 3.7 3.77 2.34.69 4.59.81 7.39 0 1.85-.54 3.7-1.62 3.7-3.77v-2.83h-7.39v-.94h11.07c2.16 0 2.96-1.5 3.7-3.76.78-2.33.74-4.57 0-6.27-.55-2.33-1.54-3.76-3.7-3.76h-2.74zm-4.16 17.6a1.39 1.39 0 0 1 1.41 1.4 1.4 1.4 0 1 1-2.8 0c0-.77.61-1.4 1.39-1.4z"
  ...
  return cloud.push(app, { region: "global" });
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center px-6 pt-12 pb-10 text-center sm:px-10 sm:pt-20 sm:pb-12">
        ...
        <p className="mt-6 max-w-xl text-balance text-sm leading-relaxed text-muted-foreground sm:mt-8 sm:text-base md:text-lg">
          A senior three-person studio delivering full-stack development, cloud infrastructure, and
          digital transformation for startups and growing businesses — with the care of a boutique
          team.
        </p>
        ...
        <div className="mt-12 flex flex-wrap items-center justify-center gap-x-10 gap-y-4 text-xs font-bold uppercase tracking-widest text-muted-foreground/80 sm:mt-16">
          {features.map(({ icon: Icon, label }) => (
            <div
              key={label}
              className="flex items-center gap-2.5 transition-colors hover:text-[var(--maroon)]"
            >
      ...
      <div className="relative z-10 mx-auto mt-2 w-full max-w-6xl px-5 pb-12 sm:mt-6 sm:px-8 sm:pb-16">
        <div className="relative hidden h-44 sm:block">
          ...
          <div className="absolute inset-0 flex items-center justify-between">
            {techStack.map((tech, i) => {
              ...
              return (
                <div key={tech.name} className={`flex flex-col items-center gap-3 ${offsets[i]}`}>
        ...
        <div className="-mx-5 flex gap-3 overflow-x-auto px-5 pb-2 sm:hidden [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          {techStack.map((tech) => (
            <div key={tech.name} className="flex shrink-0 flex-col items-center gap-2">
