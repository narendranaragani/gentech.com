import { Sparkles, ShieldCheck, Clock, Users, Headphones, GitBranch, Layers, Award } from "lucide-react";
        ...
        <div className="flex flex-col gap-16 lg:flex-row lg:items-start lg:gap-24">
          ...
          <div className="lg:sticky lg:top-32 lg:w-1/3">
            ...
            <p className="mt-8 text-base leading-relaxed text-muted-foreground sm:text-lg">
              We're a small studio by design. Everything below is a direct
              consequence of staying that way.
            </p>
          ...
          <div className="flex flex-1 flex-col gap-12 sm:gap-16">
            {features.map(({ icon: Icon, title, desc }, i) => (
              <div
                key={title}
                className="group relative flex flex-col gap-6 sm:flex-row sm:gap-10"
              >
