...
const services = [
  {
    ...
    description:
      "Production-grade React, Next.js and TypeScript applications built for performance, accessibility, and longevity.",
    deliverables: [
      "React / Next.js apps",
  ...
  },
  {
    ...
    description:
      "Infrastructure as code, serverless platforms, and resilient cloud architecture designed to scale predictably.",
  ...
  },
  {
    ...
    description:
      "Strong systems thinking, thoughtful interaction detail, and design that quietly makes products feel premium.",
    deliverables: [
      "Product UI design",
      "Design tokens",
      "Prototypes in Figma",
  ...
  },
  {
    ...
    description:
      "Reliable APIs, integrations, and developer experience your team can build on for years without rewriting.",
    deliverables: [
      "REST & GraphQL APIs",
      "Auth & permissions",
      "Stripe / webhooks",
  ...
  },
  {
    ...
    description:
      "Workflow automation and admin tools that quietly remove friction across operations, finance, and support.",
  ...
  },
  {
    ...
    description:
      "Cross-platform apps with shared codebases, native feel, and a deployment pipeline that ships weekly.",
    deliverables: [
      "React Native apps",
        ...
        <div className="relative mx-auto w-full max-w-7xl px-6 sm:px-10">
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-8 text-base leading-relaxed text-muted-foreground sm:text-lg lg:text-xl">
              Six focused practices, delivered by the same senior team from discovery through
              deployment. No silos, no hand-offs, no surprises.
            </p>
          </div>
        </div>
      </section>
                  ...
                  <ul className="mt-8 space-y-3">
                    {deliverables.map((d) => (
                      <li key={d} className="flex items-start gap-3 text-sm text-foreground/90">
                        <Check
                          className="mt-0.5 h-4 w-4 shrink-0 text-[var(--maroon)]"
                          strokeWidth={2.5}
                        />
                        <span>{d}</span>
                      </li>
