...
import { Send, Mail, Calendar, MessageSquare, ArrowRight, CheckCircle2, Loader2, ArrowLeft } from "lucide-react";
...
const channels = [
  ...
  { icon: WhatsAppIcon, label: "WhatsApp", value: "+91 63006 03869", href: "https://wa.me/916300603869" },
        ...
        <div className="space-y-10">
          ...
          <div>
            ...
            <p className="mt-8 text-base text-muted-foreground leading-relaxed max-w-md">
              I'm currently available for new projects and collaborations. Tell me about your vision, and I'll get back to you within 24 hours.
            </p>
          </div>
          ...
          <div className="pt-8 border-t border-border/40">
            <div className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground mb-4">Availability</div>
          ...
          {status === "success" ? (
            <div className="flex flex-col items-center justify-center py-12 text-center space-y-4 animate-in fade-in zoom-in duration-500">
              ...
              <p className="text-muted-foreground max-w-xs">
                Thank you for reaching out. I'll get back to you at support@gen-tech.in within 24 hours.
              </p>
              <Button
                variant="outline"
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input name="name" required placeholder="Enter your name..." className="h-12 bg-background/50 border-border/40 rounded-xl px-4" />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-1">Email</label>
                  <Input name="email" type="email" required placeholder="Enter your email..." className="h-12 bg-background/50 border-border/40 rounded-xl px-4" />
                </div>
              </div>

              <div className="space-y-2">
                <label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-1">Subject</label>
                <Input name="subject_line" required placeholder="How can I help?" className="h-12 bg-background/50 border-border/40 rounded-xl px-4" />
              </div>
